        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
            <Input
              ...
              className="bg-white/10 dark:bg-white/10 border border-white/20 text-white placeholder:text-gray-300 dark:placeholder:text-gray-400"
              value={email}
            ...
            <Button 
              type="submit" 
              className="bg-white text-primary hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-500"
